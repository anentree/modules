  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      exec-once = [        
        ...
        "swaync &"
        "systemctl --user import-environment DISPLAY WAYLAND_DISPLAY XDG_CURRENT_DESKTOP PATH"
        "teams-for-linux"
      ...
      bind = [
        ...
        "$mainMod, J, togglespecialworkspace, net.cozic.joplin_desktop"
        "$mainMod, J, exec, resize-sws"
        "$mainMod SHIFT, J, movetoworkspacesilent, special:net.cozic.joplin_desktop"
      ...
      windowrule = [        
        "tile,Aseprite"
        "float,audacious"
        "float,^(net.cozic.joplin_desktop)$"
        "center,^(net.cozic.joplin_desktop)$"
        "size 90% 85%,^(net.cozic.joplin_desktop)$"
        "workspace special:net.cozic.joplin_desktop silent,^(net.cozic.joplin_desktop)$"
        ...
        "size 70% 62%,^(floatingkitty)$"
        "float,^(com.github.stsdc.monitor)$"
        "center,^(com.github.stsdc.monitor)$"
        "size 70% 62%,^(com.github.stsdc.monitor)$"
      ...
      windowrulev2 = [
        ...
        "size 70% 62%,class:^(org.pulseaudio.pavucontrol)$"
